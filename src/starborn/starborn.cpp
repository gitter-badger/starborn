...
void ss::Starborn::play_sound(wire::string setting, bool music)
{ $
    this->clean_sounds();
    ...
    { $
        ...
        { $
            this->world_music.stop();
            this->world_music.openFromMemory(this->raw_music[this->settings[setting]].c_str(), this->raw_music[this->settings[setting]].size());
            this->world_music.play();
        }
        else
        { $
            this->title_music.stop();
            this->title_music.openFromMemory(this->raw_music[this->settings[setting]].c_str(), this->raw_music[this->settings[setting]].size());
    ...
    { $
        ...
        sound->setBuffer(this->raw_sounds[this->settings[setting]]);
        sound->play();
    ...
    std::cout << "[" << this->state.get_state() << (this->state.get_next_state().length() ? (" => " + this->state.get_next_state()) : "") << "] Playing audio: " << setting << " (" << this->settings[setting] << ")" << std::endl;
