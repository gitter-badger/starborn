...
void main()
{
	...
	gl_FragColor = vec4(vec3((rand < 0.8) ? vec3(0.0, 1.0, 1.0) : ((rand < 0.85) ? vec3(1.0, 0.0, 0.5) : vec3(0.0, 1.0, 0.5))) * (1.6 - length(((gl_FragCoord / resolution) * 2.0) - 1.0)), ((time < 3.0) ? min(1.0, time) : 1.0) * star);
}
