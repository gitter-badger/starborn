...
void main() 
{
	...
	gl_FragColor = vec4(((value < 0.05) ? vec3(0.0, 1.0, 0.5) : mix(vec3(0.0), vec3(0.0, 1.0, 1.0), pow(value, 8.0))) * (1.6 - length(((gl_FragCoord / resolution) * 2.0) - 1.0)), (time < 3.0) ? min(1.0, time) : (1.0 - (time - 3.0)));
}
